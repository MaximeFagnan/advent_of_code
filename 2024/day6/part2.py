...
oriented_visited_locations = set() # Note*
steps_taken = 0

# Note: Checking oriented visiting locations is a little faster than checking if the character has visited 4*w*l locations (in most cases)
